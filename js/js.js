const characterWarlock = {
  ...
  poisonDamage() {
    let poisonDamage = 0;
    poisonDamage += (warlockMastery.poison.poisonMastery.currentRank * warlockMastery.poison.poisonMastery.multiplier);
    return ({ name: 'Poison Damage', value: poisonDamage });
  },
  frostDamage() {
    let frostDamage = 0;
    frostDamage += (warlockMastery.frost.frostMastery.currentRank * warlockMastery.frost.frostMastery.multiplier);
    return ({ name: 'Frost Damage', value: frostDamage });
  },
  fireDamage() {
    let fireDamage = 0;
    fireDamage += (warlockMastery.fire.fireMastery.currentRank * warlockMastery.fire.fireMastery.multiplier);
    return ({ name: 'Fire Damage', value: fireDamage });
  },
  shadowDamage() {
    let shadowDamage = 0;
    shadowDamage += (warlockMastery.shadow.shadowMastery.currentRank * warlockMastery.shadow.shadowMastery.multiplier);
    return ({ name: 'Shadow Damage', value: shadowDamage });
  },
  sorceryDamage() {
    let sorceryDamage = 0;
    sorceryDamage += (warlockMastery.sorcery.sorceryMastery.currentRank * warlockMastery.sorcery.sorceryMastery.multiplier);
    return ({ name: 'Sorcery Damage', value: sorceryDamage });
  },
  curseDamage() {
    let curseDamage = 0;
    curseDamage += (warlockMastery.curse.curseMastery.currentRank * warlockMastery.curse.curseMastery.multiplier);
    return ({ name: 'Curse Damage', value: curseDamage });
  },
  baneDamage() {
    let baneDamage = 0;
    baneDamage += (warlockMastery.bane.baneMastery.currentRank * warlockMastery.bane.baneMastery.multiplier);
